...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="brand">
        <a href="index.html">
            <img src="admin_assets/img/logo-dark.png" alt="Klorofil Logo" class="img-responsive logo">
        </a>
    </div>
    <div class="container-fluid">
        ...
        <!-- <div class="navbar-btn navbar-btn-right">
            <a class="btn btn-success update-pro" href="https://www.themeineed.com/downloads/klorofil-pro-bootstrap-admin-dashboard-template/?utm_source=klorofil&utm_medium=template&utm_campaign=KlorofilPro"
        ...
        <div id="navbar-menu">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    @if (isset($userLogin))
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="fileupload/{{ $userLogin->image }}" class="img-circle" alt="Avatar">
