            ...
            <div class="form-group">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                <input id="time_show" type="text" class="form-control" name="time_shows[]" placeholder="Giá vé"  required>
                            </div>
                        </div>
